#!/usr/bin/env python
# coding: utf-8
# construct network for endothelial cell with scenicplus
...
try:
    run_scenicplus(
        ...
        upstream = [1000, 150000], #Upstream space to use for region to gene relationships
